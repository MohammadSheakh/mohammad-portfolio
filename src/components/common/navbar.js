        ...
        <>
            <div class="  h-14 w-full bg-navbarColorGray grid grid-cols-12">
                ...
                <div class="col-span-6 w-full flex ml-56 mt-3 h-10 relative">
                    ...
                    <NavLink path="/projects" styleProps="group-hover:w-14">
                        Projects
                    </NavLink>
                    <NavLink path="/timeline" styleProps="group-hover:w-14">
                        Timeline
                    </NavLink>
                    <NavLink path="/story" styleProps="group-hover:w-10">
                        Story
                    </NavLink>
                    <NavLink path="/dashboard" styleProps="group-hover:w-20">
                        DashBoard
                    </NavLink>
