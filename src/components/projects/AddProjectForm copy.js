          ...
          <div className="modal-box relative min-h-[365px] h-[600px]">
                  ...
                  {/* members: [
            {
              ...
              <div class=" py-1 mt-8 flex">
                <h5>Technology</h5>
                <NormalCheckbox style="ml-[130px]" checkBoxText="React Js" />
                <NormalCheckbox style="ml-[220px]" checkBoxText="Express Js" />
                <NormalCheckbox style="ml-[320px]" checkBoxText="Mongo DB" />
                <NormalCheckbox
                  style="ml-[130px] mt-7"
