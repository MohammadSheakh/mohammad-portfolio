...
export default function CardOption({ projectId }) {
    ...
    return (
        <>
            <div
                key={projectId}
                class="dark:bg-gray-700 w-48 text-gray-900 bg-white rounded-lg border border-gray-200  dark:border-gray-600 dark:text-white"
            >
                {/* dark:bg-gray-700 */}
                <button
